...
Ts = 7.2/Fs; # sampling interval
t = np.arange(0,7.2,Ts) # time vector; create Fs samples between 0 and 1.0 sec.
y = np.arange(0,7.2,Ts) # signal vector; create Fs samples
